...
// --------------- serde_adaptor<toml::value, rttr::variant, detail::basic_t>  ---------------
void serde_adaptor<toml::value, rttr::variant, detail::basic_t>::from(toml_v& s, std::string_view key, ValueType& data) {
    ValueType val;
...
void serde_adaptor<toml::value, rttr::variant, detail::basic_t>::into(toml_v& s, std::string_view key, const ValueType& orig_data) {
...
// --------------- serde_adaptor<toml::value, rttr::variant_polymoph_view, detail::poly_t>  ---------------
void serde_adaptor<toml::value, rttr::variant_polymoph_view, detail::poly_t>::from(toml_v& s, std::string_view key, Container& container) {
...
void serde_adaptor<toml::value, rttr::variant_polymoph_view, detail::poly_t>::into(toml_v& s, std::string_view key, const Container& data) {
...
// --------------- serde_adaptor<toml::value, rttr::variant_sequential_view, detail::seq_t>  ---------------
void serde_adaptor<toml::value, rttr::variant_sequential_view, detail::seq_t>::from(toml_v& s, std::string_view key, Sequent& seq) {
...
void serde_adaptor<toml::value, rttr::variant_sequential_view, detail::seq_t>::into(toml_v& s, std::string_view key, const Sequent& data) {
    toml::array arr;
...
// --------------- serde_adaptor<toml::value, rttr::variant_associative_view, detail::map_t>  ---------------
void serde_adaptor<toml::value, rttr::variant_associative_view, detail::map_t>::from(toml_v& s, std::string_view key, Map& map) {
...
void serde_adaptor<toml::value, rttr::variant_associative_view, detail::map_t>::into(toml_v& s, std::string_view key, const Map& data) {
    toml_v map;
...
// --------------- serde_adaptor<toml::value, rttr::variant, detail::struct_t> ---------------
void serde_adaptor<toml::value, rttr::variant, detail::struct_t>::from(toml_v& s, std::string_view key, Object& orig_data) {
...
void serde_adaptor<toml::value, rttr::variant, detail::struct_t>::into(toml_v& s, std::string_view key, const Object& _data) {
