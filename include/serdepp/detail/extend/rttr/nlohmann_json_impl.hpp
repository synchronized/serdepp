...
#ifndef __SERDEPP_DETAIL_EXTEND_RTTR_NLOHMANN_JSON_IMPL_HPP__
#define __SERDEPP_DETAIL_EXTEND_RTTR_NLOHMANN_JSON_IMPL_HPP__

namespace serde {

// --------------- serde_adaptor<nlohmann::json, rttr::variant, detail::basic_t> ---------------
void serde_adaptor<nlohmann::json, rttr::variant, detail::basic_t>::from(json& s, std::string_view key, ValueType& data) {
    ValueType val;
...
void serde_adaptor<nlohmann::json, rttr::variant, detail::basic_t>::into(json& s, std::string_view key, const ValueType& orig_data) {
...
// --------------- serde_adaptor<nlohmann::json, rttr::variant_polymoph_view, detail::poly_t> ---------------
void serde_adaptor<nlohmann::json, rttr::variant_polymoph_view, detail::poly_t>::from(json& s, std::string_view key, Container& container) {
...
void serde_adaptor<nlohmann::json, rttr::variant_polymoph_view, detail::poly_t>::into(json& s, std::string_view key, const Container& data) {
...
// --------------- serde_adaptor<nlohmann::json, rttr::variant_sequential_view, detail::seq_t> ---------------
void serde_adaptor<nlohmann::json, rttr::variant_sequential_view, detail::seq_t>::from(json& s, std::string_view key, Sequent& seq) {
    auto& arr = key.empty() ? s : s.at(std::string{key});
...
void serde_adaptor<nlohmann::json, rttr::variant_sequential_view, detail::seq_t>::into(json& s, std::string_view key, const Sequent& data) {
    json& arr = key.empty() ? s : s[std::string{key}];
    for(auto& value : data) { 
...
// --------------- serde_adaptor<nlohmann::json, rttr::variant_associative_view, detail::map_t> ---------------
void serde_adaptor<nlohmann::json, rttr::variant_associative_view, detail::map_t>::from(json& s, std::string_view key, Map& map) {
...
void serde_adaptor<nlohmann::json, rttr::variant_associative_view, detail::map_t>::into(json& s, std::string_view key, const Map& data) {
...
// --------------- serde_adaptor<nlohmann::json, rttr::variant, detail::struct_t> ---------------
void serde_adaptor<nlohmann::json, rttr::variant, detail::struct_t>::from(json& s, std::string_view key, Object& orig_data) {
...
void serde_adaptor<nlohmann::json, rttr::variant, detail::struct_t>::into(json& s, std::string_view key, const Object& _data) {
